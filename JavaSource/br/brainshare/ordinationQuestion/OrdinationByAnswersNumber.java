...
public class OrdinationByAnswersNumber implements IOrdinationStrategy{

	private Session session;
	
	public OrdinationByAnswersNumber(Session session) {
	...
	public List<Question> findQuestions(String title, String desc) throws DAOException{
		...
		try {
			List<Question> lista = session.createCriteria(Question.class).addOrder(Order.desc("countAnswer"))
					.add(Restrictions.or(
